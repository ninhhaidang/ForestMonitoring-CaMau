...
Pham và cộng sự \cite{pham2019} đã sử dụng kết hợp ảnh QuickBird, LiDAR và chỉ số địa hình GIS để nhận dạng loài cây bản địa trong cảnh quan phức tạp. Bùi và cộng sự \cite{bui2021} nghiên cứu biến động rừng ngập mặn ven biển Đồng bằng sông Cửu Long bằng chuỗi thời gian Landsat giai đoạn 1990-2020, ghi nhận xu hướng suy giảm đáng kể.
