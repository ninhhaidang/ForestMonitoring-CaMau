...
Phương pháp giám sát rừng truyền thống dựa trên điều tra thực địa tốn kém thời gian, chi phí và khó áp dụng cho diện tích rộng. Công nghệ viễn thám vệ tinh cung cấp giải pháp hiệu quả, cho phép giám sát liên tục, diện rộng với chi phí hợp lý. Chương trình Copernicus của Liên minh Châu Âu cung cấp dữ liệu miễn phí từ các vệ tinh Sentinel-1 và Sentinel-2 với độ phân giải không gian 10m và chu kỳ quay trở lại ngắn (5--6 ngày), phù hợp cho giám sát rừng nhiệt đới.
...
\textbf{Chương 1: Tổng quan về vấn biến động rừng, công nghệ viễn thám và các phương pháp giám sát} trình bày tổng quan về bối cảnh mất rừng, công nghệ viễn thám, tổng quan các nghiên cứu liên quan và các khoảng trống nghiên cứu.

\textbf{Chương 2: Cơ sở lý thuyết về viễn thám và học sâu trong giám sát biến động rừng} giới thiệu chi tiết về công nghệ viễn thám (Sentinel-1/2), lý thuyết về mạng nơ-ron tích chập, các phương pháp phân loại ảnh và các tiêu chí đánh giá mô hình.

\textbf{Chương 3: Dữ liệu, trích xuất đặc trưng và xây dựng mô hình phân loại} mô tả khu vực nghiên cứu, dữ liệu sử dụng, quy trình xử lý, kiến trúc mô hình CNN đề xuất, phương pháp huấn luyện và đánh giá.
