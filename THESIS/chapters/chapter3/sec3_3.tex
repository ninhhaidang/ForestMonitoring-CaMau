...
\textbf{(1) Batch Normalization} \cite{ioffe2015}: Được áp dụng sau mỗi lớp tích chập và lớp fully-connected, giúp ổn định quá trình huấn luyện, cho phép sử dụng learning rate cao hơn và đóng vai trò như một dạng regularization ngầm định.

\textbf{(2) Dropout với tỷ lệ 0.7} \cite{srivastava2014}: Tỷ lệ dropout 70\% được lựa chọn dựa trên các yếu tố sau:
\begin{itemize}
