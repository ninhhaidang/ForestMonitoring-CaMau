...
Sau khi huấn luyện, mô hình được áp dụng để phân loại toàn bộ vùng nghiên cứu với khoảng 16.2 triệu pixels hợp lệ. Quy trình dự đoán bao gồm: (1) Tải feature stack 27 channels cho toàn vùng; (2) Trích xuất patch 3×3 cho mỗi pixel hợp lệ; (3) Chuẩn hóa Z-score sử dụng mean/std từ tập training; (4) Forward pass qua mô hình và lấy argmax; (5) Xuất kết quả dưới dạng GeoTIFF.
