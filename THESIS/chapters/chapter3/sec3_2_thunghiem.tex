...
\subsection{Ảnh hưởng của kích thước patch}
...
Kết quả trên hoàn thành mục tiêu thứ hai và thứ ba, thiết kế và tối ưu hóa kiến trúc CNN phù hợp cho bộ dữ liệu quy mô vừa phải, đồng thời đánh giá hiệu quả của việc tích hợp dữ liệu đa nguồn, với accuracy tăng từ 93,42\% (chỉ S2) lên 98,86\% (S1+S2), cải thiện 5,44 điểm phần trăm so với việc sử dụng nguồn dữ liệu đơn lẻ.
