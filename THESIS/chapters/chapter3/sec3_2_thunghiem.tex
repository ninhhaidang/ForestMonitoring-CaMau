...
Kết quả trên hoàn thành mục tiêu đánh giá hiệu quả của việc tích hợp dữ liệu đa nguồn, với accuracy tăng từ 93.42\% (chỉ S2) lên 98.86\% (S1+S2), cải thiện 5.44 điểm phần trăm so với việc sử dụng nguồn dữ liệu đơn lẻ.
