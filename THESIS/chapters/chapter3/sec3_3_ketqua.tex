...
Kết quả kiểm định chéo cho thấy mô hình đạt được sự ổn định cao với độ lệch chuẩn của Accuracy chỉ khoảng 0.28\%. Accuracy của từng fold đều vượt ngưỡng 97.8\%, phản ánh khả năng tổng quát hóa tốt của mô hình và không có dấu hiệu quá khớp nghiêm trọng.
...
Bên cạnh ma trận nhầm lẫn, đường cong ROC (Receiver Operating Characteristic) được sử dụng để đánh giá khả năng phân biệt của mô hình. Bảng~\ref{tab:roc_auc} trình bày điểm ROC-AUC cho từng lớp.
...
Để đánh giá hiệu quả của phương pháp đề xuất, kết quả được so sánh với các công trình nghiên cứu trong tài liệu sử dụng phương pháp và dữ liệu tương tự.
...
Nghiên cứu cũng thực hiện so sánh với số liệu thống kê từ các nguồn chính thức để đánh giá tính hợp lý của kết quả phân loại:
...
Về độ tin cậy thống kê, khoảng tin cậy 95\% cho các chỉ số chính được tính toán dựa trên kết quả 5-Fold Cross Validation:
...
Mô hình đề xuất thể hiện nhiều điểm mạnh đáng chú ý. Về độ chính xác, mô hình đạt test accuracy 98.86\% và ROC-AUC 99.98\%, cho thấy khả năng phân loại xuất sắc. Việc sử dụng patch size 3×3 cho phép khai thác hiệu quả ngữ cảnh không gian và mang lại kết quả tối ưu. Sự chênh lệch nhỏ giữa CV accuracy (98.15\%) và test accuracy (98.86\%) phản ánh tính robust và khả năng tổng quát hóa tốt của mô hình mà không có dấu hiệu quá khớp. Kiến trúc CNN còn mang lại ưu điểm là không cần trích xuất đặc trưng thủ công vì mô hình tự động học đặc trưng từ dữ liệu, đồng thời thời gian huấn luyện rất hiệu quả với chỉ khoảng 15 giây cho mô hình cuối cùng.

Tuy nhiên, bên cạnh những kết quả đạt được, đồ án vẫn tồn tại một số hạn chế cần lưu ý. Về mặt hiệu suất tính toán, thời gian dự đoán toàn bộ raster còn dài (khoảng 14.83 phút cho 16.2 triệu pixel hợp lệ). Về khả năng giải thích, tính chất black-box của CNN khiến việc diễn giải kết quả phân loại trở nên khó khăn. Ngoài ra, quy mô dữ liệu thực địa còn hạn chế với chỉ 2,630 điểm mẫu, và phân tích chỉ dừng lại ở hai thời điểm mà chưa khai thác đầy đủ tiềm năng của chuỗi thời gian.

Tóm lại, chương này trình bày kết quả thực nghiệm và đánh giá mô hình CNN cho phân loại biến động rừng ngập mặn Cà Mau. Về kết quả huấn luyện, CV accuracy 5-Fold trung bình đạt 98.15\% ± 0.28\% cho thấy sự ổn định của mô hình, test accuracy đạt 98.86\% với ROC-AUC 99.98\%, trong đó hai lớp ``Phi rừng'' và ``Phục hồi rừng'' có precision và recall đạt 100\% và tổng cộng chỉ có 6/526 mẫu bị phân loại sai (tỷ lệ lỗi 1.14\%). Về kết quả phân loại vùng nghiên cứu với tổng diện tích 162,468.50 ha, rừng ổn định chiếm 74.30\% (120,716.91 ha), mất rừng chiếm 4.48\% (7,282.15 ha), phi rừng chiếm 18.17\% (29,528.54 ha), và phục hồi rừng chiếm 3.04\% (4,940.90 ha).
