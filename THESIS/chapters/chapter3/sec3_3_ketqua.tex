...
Ma trận nhầm lẫn thể hiện chi tiết kết quả phân loại, trong đó mỗi hàng tương ứng với lớp thực tế và mỗi cột tương ứng với lớp dự đoán; các phần tử trên đường chéo chính là số mẫu phân loại đúng, còn các phần tử ngoài đường chéo là các trường hợp phân loại sai.
...
Cần lưu ý rằng theo khuyến nghị của Olofsson và cộng sự \citeen{olofsson2014}, diện tích ước tính từ bản đồ phân loại cần được hiệu chỉnh dựa trên Ma trận nhầm lẫn để đảm bảo tính không chệch. Với Accuracy cao của mô hình (98.86\%, Precision và Recall đều trên 96\% cho tất cả các lớp), sai số giữa diện tích thô và diện tích hiệu chỉnh được kỳ vọng là nhỏ. Tuy nhiên, việc thực hiện hiệu chỉnh đầy đủ theo phương pháp Olofsson sẽ là hướng phát triển trong tương lai.
