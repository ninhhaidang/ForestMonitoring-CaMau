...
Với 36,676 tham số, mô hình có độ phức tạp vừa phải, phù hợp với quy mô bộ dữ liệu 2,630 mẫu.
...
Quy trình huấn luyện được thực hiện theo các bước: (1) Khởi tạo trọng số theo phương pháp Kaiming/He initialization; (2) 5-Fold Cross Validation trên 80\% dữ liệu để đánh giá độ ổn định; (3) Huấn luyện Final Model trên toàn bộ 80\% với early stopping; (4) Đánh giá trên 20\% test set cố định.
