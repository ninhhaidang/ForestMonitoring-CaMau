...
Chỉ số thực vật khác biệt chuẩn hóa (NDVI) là một trong những chỉ số quan trọng nhất trong giám sát thực vật từ viễn thám \cite{huang2021}:
\begin{equation}
...
Rừng khỏe mạnh có NBR cao (0.3--0.8) do NIR cao và SWIR thấp. Khu vực mất rừng hoặc cháy rừng có NBR thấp hoặc âm do NIR giảm và SWIR tăng. Chỉ số dNBR (differenced NBR) = NBR\textsubscript{before} - NBR\textsubscript{after} thường được sử dụng để đánh giá mức độ thiệt hại.
