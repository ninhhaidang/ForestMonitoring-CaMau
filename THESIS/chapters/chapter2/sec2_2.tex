...
Hàm kích hoạt (Activation Function) đóng vai trò quan trọng trong mạng neural, giúp mô hình học được các mối quan hệ phi tuyến trong dữ liệu \cite{goodfellow2016}.
...
Batch Normalization là kỹ thuật chuẩn hóa được đề xuất bởi Ioffe và Szegedy nhằm tăng tốc quá trình huấn luyện mạng neural sâu \cite{ioffe2015}.
...
Dropout là kỹ thuật regularization hiệu quả được đề xuất bởi Srivastava và cộng sự để ngăn chặn overfitting trong mạng neural \cite{srivastava2014}.
...
Hàm mất mát (Loss Function) đo lường sự khác biệt giữa dự đoán của mô hình và nhãn thực tế, là cơ sở để tối ưu hóa tham số mạng \cite{goodfellow2016}.
