...
% Keep UTF-8 input encoding (used by pdfLaTeX) and use T5 font encoding
% for Vietnamese (vntex) so control sequences like \uhorn, \ocircumflex, etc. are available.
...
% set font, font size and spacing (use Latin Modern for better T5 coverage under pdfLaTeX)
\usepackage{lmodern}
