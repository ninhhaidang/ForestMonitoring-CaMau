...
### 1.1.3. Tình hình rừng tại tỉnh Cà Mau
...
### 1.2.1. Ưu điểm của công nghệ viễn thám
...
### 1.2.2. Chương trình Copernicus và vệ tinh Sentinel
...
### 1.2.3. Chỉ số thực vật từ dữ liệu quang học
...
### 1.3.1. Phương pháp Machine Learning truyền thống
...
- Robust với overfitting (qua kernel và regularization)
- Hoạt động tốt với small training samples

**Hạn chế:**
- Chậm với large datasets
- Khó chọn kernel và hyperparameters phù hợp
- Không khai thác spatial information
- Kết quả khó giải thích

### 1.3.2. Phương pháp Deep Learning
...
**U-Net và Fully Convolutional Networks (FCN):**
