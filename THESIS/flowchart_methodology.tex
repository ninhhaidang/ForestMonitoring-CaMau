% Flowchart: Quy trình phương pháp nghiên cứu - Layout 3 hàng (5 bước)
% Sử dụng: \input{flowchart_methodology.tex} trong thesis.tex
...
\node[process] (p3c) at (6, -8.3) {Ghép kênh};
\node[io] (o3) at (7.7, -8.3) {27 kênh};
\draw[arrow] (p3a.east) -- ++(0.3,0) |- (p3c.west);
\draw[arrow] (p3b.east) -- ++(0.3,0) |- (p3c.west);
\draw[arrow] (p3c) -- (o3);
...
\fill[red!8, rounded corners=4pt] (-8.5, -11.4) rectangle (-0.5, -19);
\draw[red!70, line width=1.3pt, rounded corners=4pt] (-8.5, -11.4) rectangle (-0.5, -19);
...
\node[io] (d5b) at (-2.7, -14.5) {Test 20\%};
% Hàng 3: 5-Fold CV
...
\fill[teal!8, rounded corners=4pt] (0.5, -11.4) rectangle (8.5, -19);
\draw[teal!70, line width=1.3pt, rounded corners=4pt] (0.5, -11.4) rectangle (8.5, -19);
