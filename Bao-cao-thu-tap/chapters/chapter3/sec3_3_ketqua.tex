...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        % Hàng 2 (Phi rừng ổn định): 0, 0, 133, 0
        ...
        \node[font=\scriptsize, rotate=45, anchor=east] at (2.5*\cellsize, -0.2*\cellsize) {Phi rừng ổn định};
        ...
        \node[font=\scriptsize, anchor=east] at (-0.1*\cellsize, 1.5*\cellsize) {Phi rừng ổn định};
...
\hline
2 - Phi rừng ổn định & 100,00\% & 100,00\% & 100,00\% & 133 & 0 \\
\hline
...
\hline
2 & Phi rừng ổn định & 2.952.854 & 18,17\% & 29.528,54 & 295,29 \\
\hline
...
Nghiên cứu cũng thực hiện so sánh định tính với sản phẩm Giám sát rừng toàn cầu (Global Forest Watch - GFW) dựa trên công trình của Hansen và cộng sự \citeen{hansen2013}, được cập nhật liên tục bởi Potapov và cộng sự \citeen{potapov2022}.

So sánh với sản phẩm GFW, phương pháp đề xuất trong nghiên cứu này có một số ưu điểm và hạn chế. Về ưu điểm, độ phân giải không gian cao hơn (10m so với 30m của Landsat) đặc biệt có ý nghĩa với rừng ngập mặn Cà Mau, nơi các ao nuôi tôm và kênh mương thường có kích thước nhỏ, giúp phát hiện chi tiết hơn các vùng biến động quy mô vừa và nhỏ. Việc kết hợp đa nguồn dữ liệu (Sentinel-1 và Sentinel-2) cung cấp thông tin bổ sung giữa ra-đa và quang học, đặc biệt hữu ích trong điều kiện mây che phủ thường xuyên ở vùng nhiệt đới. Phương pháp CNN học sâu có khả năng tự động học các đặc trưng phức tạp từ dữ liệu, vượt trội hơn Decision Trees trong việc phân loại các lớp biến động. Hơn nữa, phương pháp có thể được cập nhật theo yêu cầu với tần suất linh hoạt tùy theo nhu cầu giám sát cụ thể của địa phương.

Tuy nhiên, GFW vẫn có những ưu thế vượt trội về tính nhất quán toàn cầu với phương pháp thống nhất trên mọi khu vực, lịch sử dữ liệu dài từ năm 2000 cho phép phân tích xu hướng dài hạn, và khả năng cập nhật tự động hàng năm mà không cần can thiệp thủ công --- những yếu tố quan trọng cho việc giám sát dài hạn ở quy mô lớn. Do đó, hai phương pháp có thể được sử dụng bổ sung cho nhau: GFW phù hợp cho giám sát xu hướng toàn cầu và dài hạn, trong khi phương pháp đề xuất phù hợp hơn cho giám sát chi tiết ở quy mô khu vực với yêu cầu độ chính xác cao.
