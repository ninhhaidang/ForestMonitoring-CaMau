...
% Đánh số trang kiểu Ả Rập
\pagenumbering{arabic}
\setcounter{secnumdepth}{2}
% Chương nội dung
\input{Chapter/Chapter1_Baitoan}\newpage\cleardoublepage
\input{Chapter/Chapter2_Muctieu}\newpage\cleardoublepage
\input{Chapter/Chapter3_Phuongphap}\newpage\cleardoublepage
\input{Chapter/Chapter4_Ketqua}\newpage\cleardoublepage
\input{Chapter/Chapter5_Ketluan}\newpage\cleardoublepage
