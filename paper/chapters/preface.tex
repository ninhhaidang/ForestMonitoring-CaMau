...
Tình trạng mất rừng đang diễn ra nghiêm trọng trên toàn cầu, đặc biệt tại các quốc gia đang phát triển. Theo báo cáo ``Global Forest Resources Assessment 2020'' của FAO \cite{fao2020}, thế giới đã mất khoảng 178 triệu ha rừng trong giai đoạn 1990--2020, tương đương diện tích của Libya.
...
Để đạt được mục tiêu trên, đồ án thực hiện bốn nội dung chính. Thứ nhất, xây dựng bộ dữ liệu huấn luyện từ ảnh vệ tinh Sentinel-1 và Sentinel-2 đa thời gian, bao gồm trích xuất các đặc trưng phổ, chỉ số thực vật và tán xạ ngược cho khu vực nghiên cứu. Thứ hai, thiết kế và tối ưu hóa kiến trúc CNN phù hợp cho bộ dữ liệu quy mô vừa phải, đánh giá ảnh hưởng của các tham số mô hình đến hiệu năng phân loại. Thứ ba, đánh giá hiệu quả của việc tích hợp dữ liệu đa nguồn (ra-đa và quang học) so với việc sử dụng từng nguồn dữ liệu riêng lẻ. Thứ tư, áp dụng mô hình đã huấn luyện để phân loại biến động rừng toàn vùng quy hoạch lâm nghiệp tỉnh Cà Mau và tạo bản đồ biến động ở độ phân giải 10m.
