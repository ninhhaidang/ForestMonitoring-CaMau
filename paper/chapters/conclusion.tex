...
Đồ án đã hoàn thành các mục tiêu đề ra với kết quả đạt được ở mức độ cao. Thứ nhất, trong công tác xây dựng bộ dữ liệu huấn luyện từ ảnh vệ tinh Sentinel-1 và Sentinel-2 đa thời gian, đồ án đã thu thập và tiền xử lý thành công dữ liệu từ hai thời kỳ (01/2024 và 02/2025) thông qua nền tảng Google Earth Engine, trích xuất được 27 đặc trưng bao gồm các kênh phổ quang học (B4, B8, B11, B12), chỉ số thực vật (NDVI, NBR, NDMI) và dữ liệu ra-đa (VV, VH) cho mỗi thời kỳ cùng với giá trị delta. Bộ dữ liệu thực địa gồm 2.630 điểm được thu thập cho 4 lớp phân loại với phân bố cân bằng, đảm bảo tính đại diện cho toàn vùng nghiên cứu. Nội dung này được hoàn thành đầy đủ với chất lượng dữ liệu đạt yêu cầu cho huấn luyện mô hình học sâu.

Thứ hai, liên quan đến thiết kế và tối ưu hóa kiến trúc CNN phù hợp cho bộ dữ liệu quy mô vừa phải, đồ án đã xây dựng thành công kiến trúc CNN với 36.676 tham số, áp dụng các kỹ thuật điều chuẩn hiệu quả gồm chuẩn hóa theo lô, Dropout 70\% và phân rã trọng số. Thông qua nghiên cứu loại trừ có hệ thống, đồ án xác định được kích thước patch 3×3 là tối ưu cho dữ liệu Sentinel 10m, đạt accuracy 98,86\% với thời gian huấn luyện chấp nhận được. Phương pháp kiểm định chéo 5 phần cho kết quả CV accuracy 98,48\% ± 0,36\%, chứng minh mô hình có độ ổn định cao và không bị quá khớp. Nội dung này được hoàn thành với kết quả vượt kỳ vọng ban đầu.

Thứ ba, đồ án thực hiện đánh giá hiệu quả của việc tích hợp dữ liệu đa nguồn so với việc sử dụng từng nguồn dữ liệu riêng lẻ thông qua nghiên cứu loại trừ toàn diện, chứng minh được sự kết hợp Sentinel-1 và Sentinel-2 cải thiện accuracy 5,44 điểm phần trăm so với chỉ sử dụng Sentinel-2 đơn lẻ (từ 93,42\% lên 98,86\%). Kết quả này khẳng định giả thuyết nghiên cứu rằng dữ liệu ra-đa và quang học có tính bổ sung cao, trong đó Sentinel-2 đóng vai trò chủ đạo còn Sentinel-1 bổ sung thông tin cấu trúc và độ ẩm. Nội dung này được hoàn thành đầy đủ với bằng chứng thực nghiệm rõ ràng.

Thứ tư, mô hình đã được triển khai thành công để phân loại biến động rừng toàn vùng quy hoạch lâm nghiệp tỉnh Cà Mau với diện tích 162.469 ha (95,5\% diện tích ranh giới), phát hiện 7.282 ha mất rừng (4,48\%) và 4.941 ha phục hồi rừng (3,04\%) trong giai đoạn nghiên cứu. Đồ án cũng xây dựng ứng dụng web trên nền tảng Google Earth Engine Apps để trực quan hóa kết quả, có thể truy cập công khai tại: \url{https://ee-bonglantrungmuoi.projects.earthengine.app/view/giam-sat-bien-dong-rung-ca-mau}. Nội dung này được hoàn thành với sản phẩm bản đồ có độ chính xác cao (98,86\%) và ứng dụng web hoạt động ổn định. Giao diện ứng dụng được minh họa trong Hình \ref{fig:ee-app}.
