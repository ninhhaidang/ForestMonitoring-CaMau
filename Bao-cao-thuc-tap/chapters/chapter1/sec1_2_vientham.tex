...
Sentinel-2 mang cảm biến quang học đa phổ thu nhận ảnh ở 13 dải phổ từ vùng nhìn thấy đến hồng ngoại sóng ngắn (443--2190 nm). Độ phân giải không gian thay đổi theo dải phổ: 10m cho các dải B2, B3, B4, B8; 20m cho B5, B6, B7, B8a, B11, B12; và 60m cho B1, B9, B10 \citeen{esa2024s2}. Với 13 dải phổ bao phủ nhiều vùng bước sóng khác nhau, có thể phân biệt các loại lớp phủ đất dựa trên đặc tính phản xạ riêng biệt của từng đối tượng. Dữ liệu đa phổ này đặc biệt phù hợp để tính toán các chỉ số thực vật phục vụ giám sát biến động rừng. Bảng \ref{tab:sentinel_comparison} tổng hợp các thông số kỹ thuật chính của hai vệ tinh này.
...
Giám sát biến động rừng là quá trình xác định sự thay đổi về diện tích, cấu trúc hoặc trạng thái của rừng giữa hai hoặc nhiều thời điểm khác nhau. Phương pháp này dựa trên việc so sánh các đặc trưng viễn thám thu được từ các thời điểm khác nhau.
