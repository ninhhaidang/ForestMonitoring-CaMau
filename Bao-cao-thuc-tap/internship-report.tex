...
% Mục lục, danh sách hình ảnh, bảng
\phantomsection
...
\unnumberedchapter{DANH MỤC HÌNH ẢNH}
\makeatletter\@starttoc{lof}\makeatother
\cleardoublepage

\phantomsection
\addcontentsline{toc}{chapter}{DANH MỤC BẢNG}
\unnumberedchapter{DANH MỤC BẢNG}
...
% I. TÊN ĐỀ TÀI
\phantomsection
\addcontentsline{toc}{chapter}{I. TÊN ĐỀ TÀI}
\input{chapters/section-1-ten-de-tai}\newpage\cleardoublepage

% II. NƠI THỰC TẬP
\phantomsection
\addcontentsline{toc}{chapter}{II. NƠI THỰC TẬP}
\input{chapters/section-2-noi-thuc-tap}\newpage\cleardoublepage

% III. NỘI DUNG THỰC TẬP
\phantomsection
\addcontentsline{toc}{chapter}{III. NỘI DUNG THỰC TẬP}
\input{chapters/section-3-noi-dung-thuc-tap}\newpage\cleardoublepage

% IV. KẾT QUẢ ĐẠT ĐƯỢC
\phantomsection
\addcontentsline{toc}{chapter}{IV. KẾT QUẢ ĐẠT ĐƯỢC}
\input{chapters/section-4-ket-qua-dat-duoc}\newpage\cleardoublepage

% Chương nội dung kỹ thuật
