...
\usepackage{titlesec}
\titleformat{\chapter}[block]{\centering\normalfont\fontsize{13pt}{16pt}\selectfont\bfseries}{PHẦN \thechapter.}{0.5em}{\MakeUppercase}
