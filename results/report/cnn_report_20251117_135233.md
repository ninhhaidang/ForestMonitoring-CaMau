...
| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.032558 |
| Best Validation Accuracy | 99.24% |
| Total Training Epochs | 66 |
| Final Training Loss | 0.043758 |
| Final Training Accuracy | 99.24% |
| Final Validation Loss | 0.035259 |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,345,689 | 88.30% | 143,456.89 |
| 1 | 🔥 Deforestation | 1,901,236 | 11.70% | 19,012.36 |
...
| Prediction Time | 14.53 minutes (871.6 seconds) |
| **Total Pipeline Time** | **14.82 minutes** |
...
- **Detected:** 1,901,236 deforestation pixels
- **Area:** 19,012.36 hectares deforested
- **Preserved:** 143,456.89 hectares intact forest
...
| **Prediction Time** | 14.5 min | ~5-10 min |
