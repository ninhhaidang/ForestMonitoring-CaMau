...
| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.029454 |
| Best Validation Accuracy | 99.49% |
| Total Training Epochs | 101 |
| Final Training Loss | 0.021765 |
| Final Training Accuracy | 99.56% |
| Final Validation Loss | 0.047905 |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,491,614 | 89.20% | 144,916.14 |
| 1 | 🔥 Deforestation | 1,755,311 | 10.80% | 17,553.11 |
...
| **Metric** | **Value** |
|------------|-----------|
| Training Time | 0.48 minutes (28.9 seconds) |
| Prediction Time | 15.27 minutes (916.4 seconds) |
| **Total Pipeline Time** | **15.75 minutes** |
...
- **Detected:** 1,755,311 deforestation pixels
- **Area:** 17,553.11 hectares deforested
- **Preserved:** 144,916.14 hectares intact forest
...
| **Prediction Time** | 15.3 min | ~5-10 min |
