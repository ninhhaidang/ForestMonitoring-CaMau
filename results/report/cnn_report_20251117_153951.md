...
| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.031857 |
| Best Validation Accuracy | 99.24% |
| Total Training Epochs | 66 |
| Final Training Loss | 0.043753 |
| Final Training Accuracy | 99.24% |
| Final Validation Loss | 0.035531 |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,288,865 | 87.95% | 142,888.65 |
| 1 | 🔥 Deforestation | 1,958,060 | 12.05% | 19,580.60 |
...
| **Metric** | **Value** |
|------------|-----------|
| Training Time | 0.29 minutes (17.4 seconds) |
| Prediction Time | 14.72 minutes (883.2 seconds) |
| **Total Pipeline Time** | **15.01 minutes** |
...
- **Detected:** 1,958,060 deforestation pixels
- **Area:** 19,580.60 hectares deforested
- **Preserved:** 142,888.65 hectares intact forest
...
| **Prediction Time** | 14.7 min | ~5-10 min |
