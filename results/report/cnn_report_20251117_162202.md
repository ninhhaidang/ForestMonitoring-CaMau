...
| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.031538 |
| Best Validation Accuracy | 99.24% |
| Total Training Epochs | 66 |
| Final Training Loss | 0.043401 |
| Final Training Accuracy | 99.18% |
| Final Validation Loss | 0.035279 |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,330,614 | 88.21% | 143,306.14 |
| 1 | 🔥 Deforestation | 1,916,311 | 11.79% | 19,163.11 |
...
| **Metric** | **Value** |
|------------|-----------|
| Training Time | 0.32 minutes (19.4 seconds) |
| Prediction Time | 14.75 minutes (884.8 seconds) |
| **Total Pipeline Time** | **15.07 minutes** |
...
- **Detected:** 1,916,311 deforestation pixels
- **Area:** 19,163.11 hectares deforested
- **Preserved:** 143,306.14 hectares intact forest
