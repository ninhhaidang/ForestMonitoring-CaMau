...
| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.038319 |
| Best Validation Accuracy | 99.24% |
| Total Training Epochs | 38 |
| Final Training Loss | 0.041928 |
| Final Training Accuracy | 98.91% |
| Final Validation Loss | 0.038971 |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,482,076 | 89.14% | 144,820.76 |
| 1 | 🔥 Deforestation | 1,764,849 | 10.86% | 17,648.49 |
...
| **Metric** | **Value** |
|------------|-----------|
| Training Time | 0.31 minutes (18.7 seconds) |
| Prediction Time | 14.72 minutes (883.2 seconds) |
| **Total Pipeline Time** | **15.03 minutes** |
...
- **Excellent ROC-AUC (0.9991)** → strong discriminative ability
...
- **Detected:** 1,764,849 deforestation pixels
- **Area:** 17,648.49 hectares deforested
- **Preserved:** 144,820.76 hectares intact forest
