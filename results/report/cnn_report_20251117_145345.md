...
| **Actual: Deforestation** | 2 (FN) | 101 (TP) |

### 3.3 Training Convergence

| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.032463 |
| Best Validation Accuracy | 99.24% |
| Total Training Epochs | 66 |
| Final Training Loss | 0.043734 |
| Final Training Accuracy | 99.24% |
| Final Validation Loss | 0.036500 |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,219,851 | 87.52% | 142,198.51 |
| 1 | 🔥 Deforestation | 2,027,074 | 12.48% | 20,270.74 |
...
| **Metric** | **Value** |
|------------|-----------|
| Training Time | 0.28 minutes (17.0 seconds) |
| Prediction Time | 15.22 minutes (913.1 seconds) |
| **Total Pipeline Time** | **15.50 minutes** |
...
- The CNN model achieved **99.24% accuracy** on the test set
- **High precision (99.25%)** → low false positive rate
- **High recall (99.24%)** → effective deforestation detection
- **Excellent ROC-AUC (0.9990)** → strong discriminative ability
...
- **Detected:** 2,027,074 deforestation pixels
- **Area:** 20,270.74 hectares deforested
- **Preserved:** 142,198.51 hectares intact forest
...
| **Training Time** | 0.3 min | ~1-2 min |
| **Prediction Time** | 15.2 min | ~5-10 min |
...
- ✅ High accuracy (99.24%) with spatial context
