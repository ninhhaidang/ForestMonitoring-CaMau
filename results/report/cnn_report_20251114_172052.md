...
| **Actual: Deforestation** | 1 (FN) | 102 (TP) |

### 3.3 Training Convergence

| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.034662 |
| Best Validation Accuracy | 99.24% |
| Total Training Epochs | 49 |
| Final Training Loss | 0.036047 |
| Final Training Accuracy | 99.08% |
| Final Validation Loss | 0.035134 |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,462,404 | 89.02% | 144,624.04 |
| 1 | 🔥 Deforestation | 1,784,521 | 10.98% | 17,845.21 |
...
| **Metric** | **Value** |
|------------|-----------|
| Training Time | 0.39 minutes (23.7 seconds) |
| Prediction Time | 15.22 minutes (913.1 seconds) |
| **Total Pipeline Time** | **15.61 minutes** |
...
- The CNN model achieved **99.49% accuracy** on the test set
- **High precision (99.49%)** → low false positive rate
- **High recall (99.49%)** → effective deforestation detection
...
- **Detected:** 1,784,521 deforestation pixels
- **Area:** 17,845.21 hectares deforested
- **Preserved:** 144,624.04 hectares intact forest
...
- ✅ High accuracy (99.49%) with spatial context
