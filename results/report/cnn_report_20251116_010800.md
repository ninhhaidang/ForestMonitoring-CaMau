...
| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.029312 |
| Best Validation Accuracy | 99.49% |
| Total Training Epochs | 101 |
| Final Training Loss | 0.021504 |
| Final Training Accuracy | 99.51% |
| Final Validation Loss | 0.048398 |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,503,070 | 89.27% | 145,030.70 |
| 1 | 🔥 Deforestation | 1,743,855 | 10.73% | 17,438.55 |
...
| **Metric** | **Value** |
|------------|-----------|
| Training Time | 0.42 minutes (24.9 seconds) |
| Prediction Time | 14.52 minutes (871.3 seconds) |
| **Total Pipeline Time** | **14.94 minutes** |
...
- **High precision (99.75%)** → low false positive rate
- **High recall (99.75%)** → effective deforestation detection
...
- **Detected:** 1,743,855 deforestation pixels
- **Area:** 17,438.55 hectares deforested
- **Preserved:** 145,030.70 hectares intact forest
...
- ✅ High accuracy (99.75%) with spatial context
