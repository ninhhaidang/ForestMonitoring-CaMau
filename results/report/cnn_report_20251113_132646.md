...
- **Class Weights:** ['0.7553', '0.8042', '2.3126']
...
| **Actual: Deforestation** | 4 (FN) | 80 (TP) |
...
| Precision | 0.9807 | 98.07% |
| Recall | 0.9807 | 98.07% |
| F1-Score | 0.9807 | 98.07% |
...
| **Actual: Deforestation** | 2 (FN) | 90 (TP) |

### 3.3 Training Convergence

| **Metric** | **Value** |
|------------|-----------|
| Best Validation Loss | 0.071496 |
| Best Validation Accuracy | 98.14% |
| Total Training Epochs | 33 |
| Final Training Loss | 0.062186 |
| Final Training Accuracy | 98.01% |
| Final Validation Loss | 0.080032 |
| Final Validation Accuracy | 97.21% |
...
|-----------|--------------|------------|----------------|---------------|
| 0 | 🌳 No Deforestation | 14,275,495 | 91.69% | 142,754.95 |
| 1 | 🔥 Deforestation | 1,294,021 | 8.31% | 12,940.21 |
...
| **Metric** | **Value** |
|------------|-----------|
| Training Time | 0.15 minutes (9.3 seconds) |
| Prediction Time | 13.34 minutes (800.1 seconds) |
| **Total Pipeline Time** | **13.49 minutes** |
...
- The CNN model achieved **98.07% accuracy** on the test set
- **High precision (98.07%)** → low false positive rate
- **High recall (98.07%)** → effective deforestation detection
- **Excellent ROC-AUC (0.9993)** → strong discriminative ability
...
- **Detected:** 1,294,021 deforestation pixels
- **Area:** 12,940.21 hectares deforested
- **Preserved:** 142,754.95 hectares intact forest
...
- ✅ High accuracy (98.07%) with spatial context
