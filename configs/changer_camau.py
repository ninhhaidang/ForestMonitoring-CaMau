...
train_dataloader = dict(
    batch_size=6,  # Moderate batch size for Changer
    num_workers=2,
...
# Dataset: 1,028 train samples, batch_size=6 -> ~171 iters/epoch
# Total: 100 epochs = ~17,100 iterations
param_scheduler = [
    dict(
...
train_cfg = dict(
    ...
    max_iters=17100,  # ~100 epochs
    val_interval=1710)  # Validate every ~10 epochs
